...
describe('Exam Management Service Tests', () => {
    ...
    it('should create an exam', fakeAsync(() => {
        ...
        const mockDto = toExamUpdateDTO({ id: 1 });
    ...
    it('should import an exam', fakeAsync(() => {
        // GIVEN
        const mockExam: Exam = { id: 1 };
        const mockImportDto = ExamManagementService.convertExamToImportDTO({ id: 1 }, course.id!);
        ...
        expect(req.request.body).toEqual(mockImportDto);
